...
// Simple inline developer icon to replace the missing <Developed /> component
const DeveloperIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-school-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l6.16-3.422A12.083 12.083 0 0118 20.5c0 .53-.03 1.05-.09 1.56A15.978 15.978 0 0012 18v-4z" />
  </svg>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 text-lg">
              <a href="/developer.html" className="text-school-blue underline">VIEW HIS WORK</a>
            </p>
          </div>
