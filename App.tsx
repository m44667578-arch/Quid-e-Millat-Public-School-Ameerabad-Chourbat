...
const App: React.FC = () => {
  ...
  const [siteImages, setSiteImages] = useState<SiteImages>({
    logoUrl: '/images/homepage/logp.jpg',
    heroImageUrls: [
    ...
    aboutImageUrl: '/images/gallery/image/533067687_1300111058171661_8786625976309702088_n.jpg',
    contactImageUrl: '/images/gallery/image/gallery6.jpg',
  });
  ...
  const initialLeadershipMessages: LeadershipMessage[] = [
    ...
    },
    {
      ...
      imageUrl: "/images/chief Proctor.jpg",
    }
  ];
